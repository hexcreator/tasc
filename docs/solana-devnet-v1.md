...
# Optional guarded wallet submitter: serve web/ as static files,
# open /production-run.html, paste the artifact, connect the required
# role wallet, enable production sends, and use the generated capture command.
