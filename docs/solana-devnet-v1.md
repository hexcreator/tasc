...
3. Add production-style finality/reorg handling and duplicate-task suppression before treating the marketplace as production-ready.
4. Start dispute-path design now that pass/fail/timeout settlement is live-proven.
5. Turn proof bundles into a hosted private-beta task feed that a buyer, worker, and verifier can operate from wallets.
